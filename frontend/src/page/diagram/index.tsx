...
const Diagrams: React.FC = () => {
    ...
    const [selectedDiagram, setSelectedDiagram] = useState<DiagramResponse | null>(null);
                ...
                <div className="relative z-10">
                        ...
                        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            <div className="min-w-0">
                                <div className="mb-2 flex flex-wrap items-center gap-1.5">
                                    ...
                                    <div className="inline-flex items-center gap-1.5 rounded-full px-2 py-1 min-w-0 bg-slate-50 text-slate-600 border border-slate-200/80 dark:bg-white/5 dark:text-white/65 dark:border-white/10">
                            ...
                            <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center sm:justify-between lg:w-auto lg:flex-col lg:items-end xl:flex-row xl:flex-wrap xl:items-center">
                                <div className="hidden md:block relative w-full sm:w-auto">
                                    ...
                                    <input
                                        ...
                                        className={["w-full sm:w-56 pl-8 pr-3", inputCls].join(" ")}
                                    />
                                </div>

                                <div className="flex w-full items-center gap-1.5 flex-wrap sm:w-auto sm:justify-end">
                                    <div className="relative min-w-0 flex-1 sm:flex-none" ref={sortRef}>
                                        ...
                                        {openSort && (
                                            <div className="absolute right-0 mt-2 w-[min(13rem,calc(100vw-2rem))] rounded-2xl overflow-hidden z-20 border border-gray-200 bg-white shadow-lg dark:border-white/10 dark:bg-[#0B1220] dark:shadow-none">
                                                <div className="py-1">
                                                    {[
                                    ...
                                    <button type="button" onClick={loadDiagrams} className={secondaryBtn}>
                                        <FiRefreshCw className="text-[12px]" />
                                        Refresh
                                    </button>

                                    <button type="button" onClick={handleOpenCreate} className={actionBtn}>
                                    ...
                                    <div className="flex items-center gap-1 shrink-0">
                                        <button
                                            ...
                                            className={[
                                                ...
                                                view === "list"
                                                    ? "bg-cyan-50 border-cyan-200 text-cyan-700 dark:bg-cyan-500/10 dark:border-cyan-400/20 dark:text-cyan-200"
                                                    : "bg-white border-gray-200/80 text-gray-500 hover:bg-gray-50 dark:bg-white/5 dark:border-white/10 dark:text-white/60 dark:hover:bg-white/8",
                                            ].join(" ")}
                                        >
                    ...
                    <div className={view === "grid" ? "min-h-105" : "min-h-80"}>
                        ...
                        {!loading && !error && filteredItems.length > 0 && (
                            <>
                                {view === "list" ? (
                                    <div className="divide-y divide-gray-100 dark:divide-white/10 min-h-105 max-h-105 overflow-y-auto">
                                        {filteredItems.map((item) => {
                                            const imageSrc = getImageSrc(item.image_base64);

                                            return (
                                                <div key={item.id} className="relative px-3 py-3 sm:px-4 sm:py-3.5">
                                                    <div className="pointer-events-none absolute top-0 right-0 h-full w-24 blur-3xl opacity-50 bg-cyan-400/10" />

                                                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                                        <div className="flex items-start gap-3 min-w-0">
                                                            <div className="h-16 w-24 sm:h-18 sm:w-28 rounded-xl overflow-hidden border border-gray-200/80 bg-slate-50 dark:bg-white/5 dark:border-white/10 shrink-0">
                                                                {imageSrc ? (
                                                                    <img
                                                                        src={imageSrc}
                                                                        alt={item.name}
                                                                    ...
                                                                    <div className="h-full w-full flex items-center justify-center text-gray-400 dark:text-white/30">
                                                            ...
                                                            <div className="min-w-0">
                                                                <div className="flex flex-wrap items-center gap-1.5">
                                                                    <span className="inline-flex items-center rounded-full border px-2 py-0.5 text-[9px] font-semibold bg-cyan-50 text-cyan-700 border-cyan-200/70 dark:bg-cyan-500/10 dark:text-cyan-300 dark:border-cyan-400/20">
                                                                        Diagram
                                                                    </span>
                                                                </div>

                                                                <h3 className="mt-1 text-[12px] sm:text-[13px] font-semibold leading-5 text-[#1f2240] dark:text-white line-clamp-2">
                                                                    {item.name || "-"}
                                                                </h3>

                                                                <p className="mt-1 text-[10.5px] leading-5 text-gray-500 dark:text-white/55 line-clamp-2">
                                    ...
                                    <div className="p-3 sm:p-4 min-h-105 max-h-105 overflow-y-auto">
                                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                                            {filteredItems.map((item) => {
                                                ...
                                                return (
                                                    <div
                                                        key={item.id}
                                                        className="relative rounded-2xl border p-3 overflow-hidden bg-white border-gray-200/80 shadow-sm dark:bg-white/5 dark:border-white/10 dark:ring-1 dark:ring-white/10 dark:shadow-none transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl"
                                                    >
                                                        <div className="pointer-events-none absolute -top-8 -right-8 h-20 w-20 rounded-full blur-3xl bg-cyan-400/10" />

                                                        <div className="relative">
                                                            <div className="h-40 w-full rounded-xl overflow-hidden border border-gray-200/80 bg-slate-50 dark:bg-white/5 dark:border-white/10">
                                                                {imageSrc ? (
                                                                    <img
                                                                        src={imageSrc}
                                                                        alt={item.name}
                                                            ...
                                                            <div className="mt-3 flex items-center justify-between gap-2">
                                                                <span className="inline-flex items-center h-6 px-2 rounded-lg border text-[10px] font-semibold bg-cyan-50 text-cyan-700 border-cyan-200/70 dark:bg-cyan-500/10 dark:text-cyan-300 dark:border-cyan-400/20">
                                                                    Diagram
                                                                </span>

                                                                <span className="inline-flex items-center h-6 px-2 rounded-lg border text-[10px] font-semibold bg-slate-50 text-slate-700 border-slate-200/70 dark:bg-white/5 dark:text-white/70 dark:border-white/10">
                                                                    ID: {item.id}
                                                                </span>
                                                            </div>

                                                            <p className="mt-2 text-[12px] font-semibold leading-5 text-[#1f2240] dark:text-white line-clamp-2">
                                                                {item.name || "-"}
                                                            </p>
                                                            ...
                                                            <div className="mt-3 grid grid-cols-3 gap-2">
                                                                ...
                                                                <button
                                                                    type="button"
                                                                    className={[dangerBtn, "w-full"].join(" ")}
                                                                    onClick={() => setDeleteTarget(item)}
                                                                >
                                                                    <FiTrash2 className="text-[12px]" />
                                                                    Delete
