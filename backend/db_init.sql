...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE ROLE pbi WITH LOGIN SUPERUSER CREATEDB CREATEROLE INHERIT REPLICATION BYPASSRLS PASSWORD '__DB_PASSWORD__';
    ELSE
        ALTER ROLE pbi WITH LOGIN SUPERUSER CREATEDB CREATEROLE INHERIT REPLICATION BYPASSRLS PASSWORD '__DB_PASSWORD__';
    END IF;
END
$$;
